...
# Form implementation generated from reading ui file 'LoadingScreen_New.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.loading_label.setText(_translate("Form", "Loading assets.."))

def loading(loadingOption):
    ui.loading_label.setText(loadingOption)
...
if __name__ == "__main__":
    ...
    index = 0
    timer = QtCore.QTimer()
    for loadingOption in loadingOptions:
        timer.timeout.connect(lambda:loading(loadingOption))
        timer.start(2000)
    sys.exit(app.exec_())
