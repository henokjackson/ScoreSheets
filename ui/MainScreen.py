...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.main_folder_groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.main_folder_groupBox.setGeometry(QtCore.QRect(40, 130, 341, 41))
        font = QtGui.QFont()
        font.setFamily("Ubuntu Mono")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.main_folder_groupBox.setFont(font)
        self.main_folder_groupBox.setObjectName("main_folder_groupBox")
        self.main_folder_path_lineEdit = QtWidgets.QLineEdit(self.main_folder_groupBox)
        self.main_folder_path_lineEdit.setGeometry(QtCore.QRect(0, 20, 281, 21))
        self.main_folder_path_lineEdit.setObjectName("main_folder_path_lineEdit")
        self.main_folder_path_pushButton = QtWidgets.QPushButton(self.main_folder_groupBox)
        self.main_folder_path_pushButton.setGeometry(QtCore.QRect(280, 20, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Ubuntu Mono")
        font.setPointSize(9)
        self.main_folder_path_pushButton.setFont(font)
        self.main_folder_path_pushButton.setObjectName("main_folder_path_pushButton")
        self.output_folder_groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.output_folder_groupBox.setGeometry(QtCore.QRect(40, 180, 341, 41))
        font = QtGui.QFont()
        font.setFamily("Ubuntu Mono")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.output_folder_groupBox.setFont(font)
        self.output_folder_groupBox.setObjectName("output_folder_groupBox")
        self.output_folder_lineEdit = QtWidgets.QLineEdit(self.output_folder_groupBox)
        self.output_folder_lineEdit.setGeometry(QtCore.QRect(0, 20, 281, 21))
        self.output_folder_lineEdit.setObjectName("output_folder_lineEdit")
        self.output_folder_pushButton = QtWidgets.QPushButton(self.output_folder_groupBox)
        self.output_folder_pushButton.setGeometry(QtCore.QRect(280, 20, 61, 21))
        font = QtGui.QFont()
        font.setFamily("Ubuntu Mono")
        font.setPointSize(9)
        self.output_folder_pushButton.setFont(font)
        self.output_folder_pushButton.setObjectName("output_folder_pushButton")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../assets/misc/Gear-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.main_folder_groupBox.setTitle(_translate("MainWindow", "Certificates PDF Folder"))
        self.main_folder_path_pushButton.setText(_translate("MainWindow", "Browse"))
        self.output_folder_groupBox.setTitle(_translate("MainWindow", "Output Folder"))
        self.output_folder_pushButton.setText(_translate("MainWindow", "Browse"))
